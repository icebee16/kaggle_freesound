...
# base : 1000
# comment : [change point] FRAME_PER_SEC {N_MEL > N_MEL*2}, SAMPLE_DURATION {2 > 4}
# ==================================================================================
...
SAMPLE_DURATION = 4  # 2[sec]
N_MEL = 128  # spectrogram y axis size
FRAME_PER_SEC = N_MEL * 2  # frame per sec
FFT_WINDOW_SIZE = 20  # 20[ms]
...
def audio_to_melspectrogram(audio, sr=SAMPLING_RATE):
    spectrogram = librosa.feature.melspectrogram(
        ...
        hop_length=int(sr / FRAME_PER_SEC),  # freq per frame
        n_fft=int((FFT_WINDOW_SIZE / 1000) * sr),  # fft window freq size
